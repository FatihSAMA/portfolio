...
export default function Contact(){
    ...
    return(
        <section ref={ref} id="contact" className=" flex flex-col items-center justify-center gap-16 min-h-screen overflow-x-hidden relative"
        >
            ...
            <a href="mailto:fatihkabul6@gmail.com"
            className=" text-center hover:text-hover text-2xl text-dark">
            ...
            className="flex gap-3">
                {
                    icons.map((icon, index) => (
                        ...
                        href={icon.url} target="_blank" key={index} 
                        >
                            {icon.svg}
                        </motion.a>
                    ))
